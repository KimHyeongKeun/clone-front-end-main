...
export default function Choose() {
  function ChooseContents(id) {
    ...
    return (
      <div>
        {list.length > 0 ? list : <span>상품이 없습니다.</span>}
      </div>
    );
  }
                            ...
                            <div className="choose-product" key={productInfo.id}>
                                ...
                                <div className='product-contents' style={{}}>
                                  <Row>
                                    ...
                                    <Rating readOnly className="choose-contents" defaultValue={productInfo.meanRate} precision={0.5} />
                                    </div>
                                  </Row>
                                </div>
                            </div>
